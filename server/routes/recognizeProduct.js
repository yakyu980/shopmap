...
const PROMPT =
  ...
  'קרא במיוחד את שם המוצר הגדול והבולט שמודפס על חזית האריזה; אל תחזיר רק קטגוריה כללית אם שם מסחרי נראה בתמונה. ' +
  'אם שם המוצר כתוב בעברית, העתק אותו בעברית כפי שהוא נראה. ' +
